...
export default function TestimonialSection() {
    return (
        <div id="testimonials" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Testimonials" text2="What Creators Say About Thumbler" text3="Feedback from creators using Thumbler to simplify and improve their thumbnail creation workflow." />
